...
const PANEL_POSITION: Vector2 = Vector2(12.0, 12.0)
const PANEL_SIZE: Vector2 = Vector2(386.0, 58.0)
const CARD_SIZE: Vector2 = Vector2(88.0, 42.0)
...
func _add_resource_card(
	...
	accent.custom_minimum_size = Vector2(7.0, 26.0)
...
func _on_resources_changed(new_gold: int, new_wood: int, new_stone: int, new_iron: int) -> void:
